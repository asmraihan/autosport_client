            ...
            <section className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                ...
                <div className="grid mb-8 lg:mb-12 lg:grid-cols-2">
                    <figure data-aos="fade-right"
                        className="flex flex-col justify-center items-center p-8 text-center border-b md:p-12 lg:border-r bg-zinc-900 border-gray-700">
                    ...
                    <figure data-aos="fade-left" className="flex flex-col justify-center items-center p-8 text-center border-b  md:p-12 bg-zinc-900/90 border-gray-700">
                        <blockquote className="mx-auto mb-8 max-w-2xl text-gray-400">
                            <h3 className="text-lg font-semibold text-white">
                    ...
                    <figure data-aos="fade-right" className="flex flex-col justify-center items-center p-8 text-center bg-gray-50 border-b lg:border-b-0 md:p-12 lg:border-r bg-zinc-900/90 border-gray-700">
                        <blockquote className="mx-auto mb-8 max-w-2xl text-gray-400">
                            <h3 className="text-lg font-semibold text-white">
                    ...
                    <figure data-aos="fade-left" className="flex flex-col justify-center items-center p-8 text-center md:p-12 bg-zinc-900 border-gray-700">
                        <blockquote className="mx-auto mb-8 max-w-2xl text-gray-400">
                            <h3 className="text-lg font-semibold text-white">
